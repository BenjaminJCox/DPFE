...
θ = [0.91, 0.5, 1.0] #parameters from https://www.stats.ox.ac.uk/~doucet/doucet_johansen_tutorialPF2011.pdf
...
_grd_tp[:, 1] = en_grad_fwd(θ_in, pθ, test_pf)
_β = 0.2
_tsb = 75
...
for i = 2:_nit
    ...
    _grd = en_grad_fwd(θ_tp[:, i-1], pθ, test_pf)
